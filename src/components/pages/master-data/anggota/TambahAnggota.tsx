...
const formSchema = z.object({
  nip: z.string().max(10, "NIP maksimal 10 karakter"),
  name: z
    .string()
    .max(50, "Nama maksimal 50 karakter")
    .nonempty("Nama harus diisi"),
  accountNumber: z.string().max(20, "Nomor rekening maksimal 20 karakter"),
  bank: z.string().max(20, "Nama bank maksimal 20 karakter"),
  phoneNumber: z.string().max(15, "Nomor telepon maksimal 15 karakter"),
