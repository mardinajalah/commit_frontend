...
const formSchema = z.object({
  ...
  retailPrice: z
    .number()
    .nonnegative("Harga ecer tidak boleh negatif")
    .min(1, "Harga ecer harus diisi"),
  wholesalePrice: z
    .number()
    .nonnegative("Harga grosir tidak boleh negatif")
    .min(1, "Harga grosir harus diisi"),
  stock: z
    .number()
  ...
  minStock: z
    .number()
    .nonnegative("Stok minimal tidak boleh negatif")
    .min(1, "Stok minimal harus diisi"),
  barcode: z
    .string()
    .min(1, "Nomor barcode harus diisi")
    .max(20, "Nomor barcode maksimal 20 karakter"),
  ...
  size: z.number().min(1, "Ukuran harus diisi"),
  unitId: z
    .number()
...
const TambahBarang = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const url = paramId
      ? `http://localhost:3000/api/product/${paramId}`
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            {errors.wholesalePrice && (
              <p className="text-red-500 text-sm">{errors.wholesalePrice}</p>
            )}
          </div>
          <div>
